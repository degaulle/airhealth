...
<b>To run it, please download all the files into one folder (e.g. airvisual) and open the terminal (search for terminal in macbook applications) and cd to this folder (cd Downloads/airvisual) and run the following command:  python -m SimpleHTTPServer 8080 , and then open a browser window and go to http://localhost:8080/, and then you can see the three different visualizations.</b>
